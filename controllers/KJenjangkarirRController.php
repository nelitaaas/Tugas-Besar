...
class KJenjangkarirRController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['KJenjangkarirR'];
			if($model->save())
				$this->redirect(array('admin','id'=>$model->jenjangkarir_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('KJenjangkarirR');
	...
	{
		$model=new KJenjangkarirR('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['KJenjangkarirR']))
			$model->attributes=$_GET['KJenjangkarirR'];
	...
	{
		$model=KJenjangkarirR::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='kjenjangkarir-r-form')
		{
			...
			Yii::app()->end();
                ...
                {
                    $model= new KJenjangkarirR;
                    $model->attributes=$_REQUEST['KJenjangkarirR'];
