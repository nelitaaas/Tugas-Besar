...
class MastergajiMController extends Controller
{
	...
	{
		$model=new MastergajiM;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['MastergajiM']))
		{
			$model->attributes=$_POST['MastergajiM'];
			if($model->save())
				$this->redirect(array('admin','id'=>$model->mastergaji_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('MastergajiM');
	...
	{
		$model=new MastergajiM('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['MastergajiM']))
			$model->attributes=$_GET['MastergajiM'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mastergaji-m-form')
		{
        ...
        {
            $model= new MastergajiM;
            $model->attributes=$_REQUEST['MastergajiM'];
            $judulLaporan='Daftar Total Gaji';
