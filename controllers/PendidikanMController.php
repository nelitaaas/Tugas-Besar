...
class PendidikanMController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('PendidikanM');
	...
	{
		$model=new PendidikanM('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PendidikanM']))
			$model->attributes=$_GET['PendidikanM'];
	...
	{
		$model=PendidikanM::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pendidikan-m-form')
		{
        ...
        {
            $model= new PendidikanM;
            $model->attributes=$_REQUEST['PendidikanM'];
            $judulLaporan='Rekapitulasi Data Pendidikan';
