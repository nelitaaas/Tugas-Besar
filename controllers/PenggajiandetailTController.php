...
class PenggajiandetailTController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['PenggajiandetailT'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->penggajiandetail_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('PenggajiandetailT');
	...
	{
		$model=new PenggajiandetailT('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PenggajiandetailT']))
			$model->attributes=$_GET['PenggajiandetailT'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='penggajiandetail-t-form')
		{
			...
			Yii::app()->end();
                ...
                {
                    $model= new PenggajiandetailT;
                    $model->attributes=$_REQUEST['PenggajiandetailT'];
