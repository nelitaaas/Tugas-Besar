...
class PropinsiMController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['PropinsiM'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('PropinsiM');
	...
	{
		$model=new PropinsiM('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PropinsiM']))
			$model->attributes=$_GET['PropinsiM'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='propinsi-m-form')
		{
        ...
        {
            $model= new PropinsiM;
            $model->attributes=$_REQUEST['PropinsiM'];
            $judulLaporan='Rekapitulasi Data Propinsi';
