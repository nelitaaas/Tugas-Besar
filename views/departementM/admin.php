...
<?php $this->renderPartial('_search',array(
    ...
    $('form#cariSearch').submit(function(){
            $.fn.yiiGridView.update('departement-m-grid', {
                    data: $(this).serialize()
            });
            return false;
    });   
...
<div class="mws-panel">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">Tabel Departement </span>
    </div>
    <div class="mws-panel-body">
        <div class="mws-panel-toolbar top clearfix">
            <ul>
                <li><a class="mws-ic-16 ic-add" href="index.php?r=kepegawaian/departementM/create">Tambah Departement</a></li>
            </ul>
        </div>
        <div class="mws-table">
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
                        ...
                        'selectableRows'=>0,
                        'id'=>'rows',
                        'checked'=>'$data->departement_aktif',
                ),
		array(
                    'header'=>'Lihat',
                    'class'=>'CButtonColumn',                                  
