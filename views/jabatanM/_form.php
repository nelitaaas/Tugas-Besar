...
<div class="mws-panel">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-list">Form Jabatan </span>
    </div>
	...
	<div class="mws-form-message info">Bagian dengan tanda <span class="required">*</span> harus diisi.</div>
                ...
                <div class="mws-form-inline">   
                        ...
                        <tr>
                            <td>  
                                <div class="mws-form-row">
                                     <?php echo $form->labelEx($model,'jabatan_nama'); ?>
                                ...
                                <div class="mws-form-row">
                                     <?php echo $form->labelEx($model,'jabatan_aktif'); ?>
                 ...
                 <div class="mws-button-row">
                    <?php echo Chtml::link('Back',$url='index.php?r=kepegawaian/jabatanM/admin', array('class' => 'mws-button gray left')); ?>
                    <?php 
