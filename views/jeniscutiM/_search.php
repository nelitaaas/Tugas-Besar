<div class="mws-panel mws-collapsible2">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-magnifying-glass-2">Pencarian Jenis Cuti</span>
    </div>
        ...
        <tr>
            <td>
                <div class="mws-form-row">
                     <?php echo $form->label($model,'jeniscuti_nama'); ?>
                ...
                <div class="mws-form-row">
                     <?php echo $form->label($model,'jeniscuti_aktif'); ?>
                     <div class="mws-form-item ">		
                          <?php echo $form->checkBox($model,'jeniscuti_aktif',array('size'=>15,'maxlength'=>50, 
                                                      'onkeypress'=>'return $(this).focusNextInputField(event);','checked'=>'checked')); ?>
                     </div>
                </div>
            </td>
        </tr>
