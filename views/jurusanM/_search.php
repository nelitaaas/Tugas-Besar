<div class="mws-panel mws-collapsible2">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-magnifying-glass-2">Pencarian Jurusan</span>
    </div>
        ...
        <tr>
           <td>
               <div class="mws-form-row">
                     <?php echo $form->label($model,'jurusan_nama'); ?>
               ...
               <div class="mws-form-row">
                     <?php echo $form->label($model,'jurusan_aktif'); ?>
                     <div class="mws-form-item small">		
                          <?php echo $form->checkBox($model,'jurusan_aktif',array( 'onkeypress'=>'return $(this).focusNextInputField(event);','checked'=>'checked')); ?>
                    </div>
               </div>
           </td>
        </tr>
