...
<?php $this->renderPartial('_search',array(
    ...
    $('form#cariSearch').submit(function(){
            $.fn.yiiGridView.update('jurusan-m-grid', {
                    data: $(this).serialize()
            });
            return false;
    });   
...
<div class="mws-panel">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">Tabel Jurusan </span>
    </div>
    <div class="mws-panel-body">
        <div class="mws-panel-toolbar top clearfix">
            <ul>
                <li><a class="mws-ic-16 ic-add" href="index.php?r=kepegawaian/jurusanM/create">Tambah Jurusan</a></li>
            </ul>
        </div>
        <div class="mws-table">
