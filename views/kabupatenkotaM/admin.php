...
<?php $this->renderPartial('_search',array(
    ...
    $('form#cariSearch').submit(function(){
            $.fn.yiiGridView.update('kabupatenkota-m-grid', {
                    data: $(this).serialize()
            });
            return false;
    });   
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
                    'header'=>'Propinsi',
                    'name'=>'propinsi_id',
                    'filter'=>CHtml::listData(PropinsiM::model()->findAll(),'propinsi_id','propinsi_nama'),
                    'value'=>'isset($data->propinsi->propinsi_nama) ? $data->propinsi->propinsi_nama : ""',
                ),
		array(
		...
		array(
                        ...
                        'selectableRows'=>0,
                        'id'=>'rows',
                        'checked'=>'$data->kabupatenkota_aktif',
                ),
		array(
                    'header'=>'Lihat',
                    'class'=>'CButtonColumn',                                  
