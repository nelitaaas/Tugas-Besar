...
<!--                            <div class="mws-form-item ">                                            
                            ...
                            <div class="mws-form-row">
                                    <?php echo $form->labelEx($modelp,'lamapendidikan'); ?>
                                     <div class="mws-form-item ">                                            <?php echo $form->textField($modelp,'lamapendidikan',array('onKeyUp'=>'checkInput(this);','maxlength'=>30,'style'=>'width:130px;','onkeypress'=>"return $(this).focusNextInputField(event)")); ?> Tahun
                                      </div>
                            </div>
                            <div class="mws-form-row">
                                    <?php echo $form->labelEx($modelp,'no_ijazah'); ?>
                                     <div class="mws-form-item ">                                            <?php echo $form->textField($modelp,'no_ijazah',array('onKeyUp'=>'checkInput(this)','maxlength'=>100,'style'=>'width:180px;','onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                                      </div>
                            </div>
                            <div class="mws-form-row">
                            ...
                            <div class="mws-form-row">
                                    <?php echo $form->labelEx($modelp,'gradelulus'); ?>
                                     <div class="mws-form-item ">                                            
                                    <?php echo $form->dropDownList($modelp,'gradelulus', CHtml::listData(Params::getLookup(Params::GRADE), 'lookup_nama', 'lookup_nama'),array('empty'=>'','style'=>'width:130px;', 'empty'=>'--Pilih--','onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                                      </div>
                            </div>
                 ...
                 <div class="mws-button-row">
                    <?php
                            echo CHtml::submitButton($modelp->isNewRecord ? 'Create' : 'Create', array('class' => 'mws-button blue','type'=>'submit','onKeyPress'=>'return formSubmit(this,event)'));                
                            echo "  ";
