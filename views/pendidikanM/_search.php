<div class="mws-panel mws-collapsible2">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-magnifying-glass-2">Pencarian Pendidikan</span>
    </div>
        ...
        <tr>
            <td>
                <div class="mws-form-row">
                     <?php echo $form->label($model,'pendidikan_nama'); ?>
                ...
                <div class="mws-form-row">
                     <?php echo $form->label($model,'pendidikan_urutan'); ?>
                     <div class="mws-form-item ">		
                          <?php echo $form->textField($model,'pendidikan_urutan', array('size'=>5,'onkeypress'=>'return $(this).focusNextInputField(event);',
                                                      'class'=>'mws-textinput')); ?>
                     </div>
               </div>
                
               <div class="mws-form-row">
                     <?php echo $form->label($model,'pendidikan_aktif'); ?>
