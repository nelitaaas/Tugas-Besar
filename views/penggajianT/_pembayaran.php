                ...
                <div class="mws-form-inline">   
                    <table>
                        <tr>
                            <td width="50%">
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        <?php //echo CHtml::activedropDownList($modPengeluarankas,'namapenerima',CHtml::listData($modPengeluarankas->getKaryawanItems(),'nama_karyawan','nama_karyawan'),array('empty'=>'-- Pilih --','style'=>'width:234px')); ?>
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    <?php echo $form->labelEx($modPengeluarankas,'pegpengeluran'); ?>
                                     <div class="mws-form-item ">                                            
                            ...
                            <div class="mws-form-row">
                                   <?php echo $form->labelEx($modPengeluarankas,'pegmengetahui'); ?>
                                     <div class="mws-form-item ">                                            
                 ...
                 <div class="mws-button-row">
                    <?php
                        echo CHtml::submitButton($model->isNewRecord ? 'Create' : 'Create', array('class' => 'mws-button blue','click'=>'("#dialogPembayaran").dialog("close")'))."&nbsp; &nbsp;";
