...
<div class="mws-panel">
    ...
    <div class="mws-panel-body">
        <div class="mws-form">
            ...
            <?php
            if ($form->errorSummary($modPengeluarankas)) {
                echo '<div class="mws-form-message error">' . $form->errorSummary($modPengeluarankas) . '</div>';
            }
            ?>         
                        ...
                        <td>
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item ">
                                    <?php //echo $form->textField($model,'pinjamanpeg_id',array('readonly'=>true)); ?>
                                    <?php echo $form->hiddenField($model,'karyawan_id',array('readonly'=>true)); ?>
                                    <?php $this->widget('MyJuiAutoComplete', array(
                                                           'name'=>'karyawan',
                                                           'value' => $model->karyawan->nama_karyawan,
...
//                                            'class'=>'dtpicker3',
                        ...
                        <td>
                            ...
                            <div class="mws-form-row">
                                    <?php echo $form->labelEx($model,'pegpengeluran',array('class'=>'required')); ?>
                                     <div class="mws-form-item ">                                            
                                                <?php $this->widget('MyJuiAutoComplete', array(
                                                   'name'=>'pegpengeluaran',
                                                    'source'=>'js: function(request, response) {
                        ...
                        if (isset($modDetails)) {
                            foreach ($modDetails as $i => $data) {
                                ...
                                echo '</td><td>' . CHtml::activeTextField($data, '[' . $i . ']tglakanbayar', array('class' => 'numbersOnly span3')) . '</td>
                                            ...
                                            <td>' . CHtml::activeHiddenField($data, '[' . $data->pinjamanpeg_id . ']pinjamanpeg_id', array('class' => 'numbersOnly span1 ')) . '</td>';
                                if ($model->isNewRecord) {
