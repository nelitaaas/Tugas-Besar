...
<?php $this->renderPartial('_search',array(
    ...
    $('form#cariSearch').submit(function(){
            $.fn.yiiGridView.update('propinsi-m-grid', {
                    data: $(this).serialize()
            });
            return false;
    });   
...
<div class="mws-panel">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">Tabel Propinsi </span>
    </div>
    <div class="mws-panel-body">
        <div class="mws-panel-toolbar top clearfix">
            <ul>
                <li><a class="mws-ic-16 ic-add" href="index.php?r=kepegawaian/propinsiM/create">Tambah Propinsi</a></li>
            </ul>
        </div>
        <div class="mws-table">
