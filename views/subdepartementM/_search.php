<div class="mws-panel mws-collapsible2">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-magnifying-glass-2">Pencarian Sub Departement</span>
    </div>
        ...
        <tr>
            <td>
                <div class="mws-form-row">
                     <?php echo $form->label($model,'subdepartement_nama'); ?>
               ...
               <div class="mws-form-row">
                    <?php echo $form->label($model,'subdepartement_akitf'); ?>
