...
<?php $this->renderPartial('_search',array(
    ...
    $('form#cariSearch').submit(function(){
            $.fn.yiiGridView.update('subdepartement-m-grid', {
                    data: $(this).serialize()
            });
            return false;
    });   
...
<div class="mws-panel">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">Tabel Sub Departement</span>
    </div>
    <div class="mws-panel-body">
        <div class="mws-panel-toolbar top clearfix">
            <ul>
                <li><a class="mws-ic-16 ic-add" href="index.php?r=kepegawaian/subdepartementM/create">Tambah Sub Departement</a></li>
            </ul>
        </div>
        <div class="mws-table">
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'subdepartement-m-grid',
	...
	'columns'=>array(
		...
		'subdepartement_nama',
                array(
                    ...
                    'selectableRows'=>0,
                    'id'=>'rows',
                    'checked'=>'$data->subdepartement_akitf',
                ),
		array(
                    'header'=>'Lihat',
                    'class'=>'CButtonColumn',                                  
